...
const WalkingBotGame = () => {
  ...
  // Language basics content
  const languageBasics = {
    java: "Java is an object-oriented programming language. Key features include platform independence and strong typing.",
    python: "Python is known for its simplicity and readability. It supports multiple programming paradigms.",
    rust: "Rust focuses on memory safety without using garbage collection. It's great for systems programming.",
    solidity: "Solidity is used for developing smart contracts on the Ethereum blockchain."
  };
  ...
  const challengeQuestions = [
    {
      ...
      options: ["Object-Oriented Programming", "Object-Oriented Protocol", "Operational Object Process"],
    ...
    {
      question: "What is the primary use of the 'async' keyword in JavaScript?",
      options: ["Creating loops", "Handling asynchronous operations", "Defining constants", "Creating classes"],
      correctAnswer: "Handling asynchronous operations"
    },
    {
      question: "In Python, what does the 'self' parameter refer to?",
      options: ["The current module", "The current function", "The current class instance", "The global variable"],
      correctAnswer: "The current class instance"
    },
    {
      question: "What is a smart contract primarily used for?",
      options: ["Web design", "Blockchain transactions", "Database management", "Network security"],
      correctAnswer: "Blockchain transactions"
    },
    {
      question: "Which Rust feature prevents null or dangling pointer references?",
      options: ["Garbage collection", "Ownership system", "Try-catch blocks", "Virtual machines"],
    ...
    },
    {
      ...
      options: ["To run programs", "To debug code", "To translate source code to machine code", "To create variables"],
      correctAnswer: "To translate source code to machine code"
    },
    {
      question: "In blockchain, what is a 'gas fee'?",
      options: ["A physical gas", "Transaction cost on Ethereum", "A cooling system", "A programming error"],
      correctAnswer: "Transaction cost on Ethereum"
    }
  ];
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="relative w-full max-w-lg h-64 bg-blue-200 rounded-lg overflow-hidden mb-4">
        ...
        {gameState === 'language-selection' && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg max-w-md w-full">
              <h2 className="text-xl font-bold mb-4 text-blue-600">Select a Language</h2>
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg max-w-xs">
              <h2 className="text-xl font-bold mb-2 text-blue-600">
                {selectedLanguage.charAt(0).toUpperCase() + selectedLanguage.slice(1)} Basics
              </h2>
        ...
        {gameState === 'challenge-start' && currentQuestion && (
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg max-w-md w-full">
              <h2 className="text-xl font-bold mb-4 text-red-600">Challenge Question</h2>
        ...
        {gameState === 'challenge-end' && (
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg max-w-xs">
              <h2 className="text-xl font-bold mb-2 text-red-600">Challenge Complete!</h2>
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-gray-700">
          {gameState === 'start' ? 'Ready to start your adventure?' : 
           gameState === 'walking' ? 'Bot is walking...' : 
           gameState === 'standing' ? 'Choose an option!' : 
           gameState === 'language-selection' ? 'Select a language to learn' : 
           gameState === 'challenge-start' ? `Current Score: ${score}/10` : 
